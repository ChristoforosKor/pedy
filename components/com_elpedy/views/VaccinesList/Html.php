...
namespace components\com_elpedy\views\VaccinesList;
...
class Html extends View {
    ...
    public function render() {
        ...
        $this->VaccineEditUrl = $endPoints['VaccinesEdit'];
    ...
    private function getJsonUrls() {
        return array_map(
            ...
            return Route::_('index.php?option=com_elpedy&Itemid=' . $val . '&format=json', false);
                ...
                , ELComponent::getEndPointsItems(['VaccinesListData'])
        );
    }
    ...
    private function getHTMLUrls() {
        return array_map(
            ...
            return Route::_('index.php?option=com_elpedy&Itemid=' . $val . '&format=html', false);
                ...
                , ELComponent::getEndPointsItems(['VaccinesEdit'])
        );
    }
