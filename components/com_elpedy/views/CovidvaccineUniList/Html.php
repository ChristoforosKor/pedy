...
namespace components\com_elpedy\views\CovidvaccineUniList;
...
class Html extends View {
    ...
    public function render() {    
        ...
        $this->CovidVaccineEditUrl = $endPoints['CovidVaccineUniEdit'];
        $this -> covidVaccineForm = Form::getInstance("covidvaccineuni", "covidvaccineuni");
...
//        print_r($state);
    ...
    private function getJsonUrls() {
        return array_map(
                ...
                , ELComponent::getEndPointsItems(['CovidVaccineUniListData', 'CovidVaccineUniSaveData'])
    ...
    private function getHTMLUrls() {
        return array_map(
            ...
            return Route::_('index.php?option=com_elpedy&Itemid=' . $val . '&format=html', false);
                ...
                , ELComponent::getEndPointsItems(['CovidVaccineUniEdit'])
