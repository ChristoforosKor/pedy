...
namespace components\com_elpedy\views\CovidvaccineList;
...
class Html extends View {
    ...
    public function render() {    
        ...
        $this->CovidVaccineEditUrl = $endPoints['CovidVaccineEdit'];
        $this -> covidVaccineForm = Form::getInstance("covidvaccine", "covidvaccine");
    ...
    private function getJsonUrls() {
        return array_map(
                ...
                , ELComponent::getEndPointsItems(['CovidVaccineListData', 'CovidVaccineSaveData'])
    ...
    private function getHTMLUrls() {
        return array_map(
            ...
            return Route::_('index.php?option=com_elpedy&Itemid=' . $val . '&format=html', false);
                ...
                , ELComponent::getEndPointsItems(['CovidVaccineEdit'])
