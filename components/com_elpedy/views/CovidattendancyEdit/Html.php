...
----------------------------------**/
namespace components\com_elpedy\views\CovidattendancyEdit;
...
class Html extends View
{
    public function render() {
        ...
        ,ELComponent::getEndPointsItems( ['VaccinesEditData', 'VaccinesSaveData']) 
                );        
        ...
        $this -> VaccinesSaveUrl = $endPoints['VaccinesSaveData'];
