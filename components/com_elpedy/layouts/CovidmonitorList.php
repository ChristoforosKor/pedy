...
<section class="el covid-monitor-section container">
    ...
    <div id="CovidMonitorListToolbar">
        ...
        <form role="form" id="covidMonitorHead" style="display:none">
            <?php echo $this->covidMonitorForm->getInput("id"); ?>
            <div class="row">
                <h3>
                    <div class="col-md-3">
                        <?php
...
<div class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="Διαγραφή Εγγραφής" aria-hidden="true" id="covidMonitorDeleteForm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $this->covidMonitorForm->getInput("idCovidMonitorDetails"); ?>
                <div class="row">
                <fieldset class="col-md-12" >
                        <legend> Στοιχεία Εξεταζόμενου</legend>
	 ...
	 <fieldset  class="col-md-12"  >
                        <legend> Ιατρικά στοιχεία</legend>
                   				
                    <div class="col-md-6">
                        <?php echo $this->covidMonitorForm->getLabel("id_ClinicType"), $this->covidMonitorForm->getInput("id_ClinicType"); ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo $this->covidMonitorForm->getLabel("clinic_phone"), $this->covidMonitorForm->getInput("clinic_phone"); ?>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6" id="ResultDateContainer">
                        <?php echo $this->covidMonitorForm->getLabel("ResultDate"), $this->covidMonitorForm->getInput("ResultDate"); ?>
                    </div>
                     <div class="col-md-6">
                        <?php echo $this->covidMonitorForm->getLabel("id_PersonelSpeciality"), $this->covidMonitorForm->getInput("id_PersonelSpeciality"); ?>
                    </div>
					<div class="col-md-6">
                        <?php echo $this->covidMonitorForm->getLabel("dep_phone"), $this->covidMonitorForm->getInput("dep_phone"); ?>
                    </div>
                    <div class="col-md-6" id="HomeVisitDateContainer" >
                    ...
                    <div class="col-md-6"  id="HomeVisitNoContainer">
...
<script  type="module">
    ...
    document.addEventListener('DOMContentLoaded', function(e){
        ...
        document.getElementById('covidMonitorDetailsForm').addEventListener('submit', function(e){
         ...
         document.getElementById('covidMonitorDeleteForm').addEventListener('submit', function(e){
            e.preventDefault();
            CovidAttendancyList.delDetail(e);
       });
        
        jQuery( "#addCovidMonitor" ).on('shown.bs.modal', function(e){
             CovidMonitorList.showDetails(e);
