...
<div class="covid-vaccine" >
    <section class="el covid-Vaccine-section section" style="margin-bottom: 3rem" >
		...
		Για το νέο εμβόλιο Pfizer Omicron XBB 1.5 πραγματοποιούνται κανονικά καταχωρήσεις εμβολιασμών και παραλαβών/απορρίψεων δόσεων στα νέα πεδία που δημιουργήθηκαν.
		</div>
...
-->						
    ...
    <section class="section covidVaccineDetails " style="display:none" >
        <?php  
        
        require_once __DIR__ . '/CovidvaccineListSectionType2.php'; ?>
    </section>
</div>
...
<script  type="module">
    ...
    import * as CovidVaccineList from  '/media/com_elpedy/js/CovidVaccineList.js?ver=2'  ;
    CovidVaccineList.init({
    tableSelector: '.covidVaccineTable'
    , dataUrl: Joomla.getOptions('com_elpedy')['CovidVaccineListData']
    , editUrl :  Joomla.getOptions('com_elpedy')['CovidVaccineEdit'] 
    , delUrl: Joomla.getOptions('com_elpedy')['CovidVaccineDeleteData']  //'index.php?option=com_elpedy&view=CovidVaccineDeleteData&format=json'
    , saveUrl:  Joomla.getOptions('com_elpedy')['CovidVaccineSaveData']
    , covidVaccineDetails: document.querySelector('.covidVaccineDetails')                                                                          
