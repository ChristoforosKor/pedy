...
class Controller extends JControllerBase{
	...
	*/
	...
	public static function getViewWithModel($appData, $state=null)
	{
		return Factory::getView($appData['componentname'], $appData['view'],  Factory::getModel($appData['componentname'], $appData['model'], ($state === null ? new JRegistry($appData) : $state)),$appData['format']);
	}
