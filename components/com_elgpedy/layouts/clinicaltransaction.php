...
echo '<section id="elgdata"><div class="row"><div class="col-md-12"><table class="table table-hover table-bordered clinicTransaction" ><tbody><tr><th class="info">', JText::_('COM_ELG_PEDY_CHECKER'), '</th><td id="elginc0-4" class="col-md-2 ', $this -> checkers, ' editable" data-inputclass="edit-text" >', $this -> checkers, '</td></tr></tbody></table></div><div class="clearfix"></div></div><div class="row">';
