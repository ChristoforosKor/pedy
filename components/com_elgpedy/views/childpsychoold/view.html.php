...
-----------------------------------------------------------------------**/
  ...
  */
   ...
   class ElgPedyViewChildPsychoOld extends DataCommon
   {
		...
		public function render()
		{
                    ...
                    $this->dataClinical = ViewUtils::ClinicalReform($data->data); // $this->reform($data->data);
                    $departments = array();
                    ...
                    $this->dataLayout = 'childpsychoold.php';
