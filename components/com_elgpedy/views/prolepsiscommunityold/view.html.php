...
-----------------------------------------------------------------------**/
  ...
  */
   ...
   class ElgPedyViewProlepsisCommunityOld extends DataCommon
   {
		protected $fields;
		public function render()
		{
			...
			//$this -> dataProlepsis = ViewUtils::ProlepsisReformDoctor($data->data); //$dataProlepsis;
		
			$this->dataLayout = 'prolepsiscommunityold.php';			
