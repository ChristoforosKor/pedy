...
require_once JPATH_COMPONENT_SITE . '/models/clinicaltransactionreportold.php'; 
require_once JPATH_COMPONENT_SITE . '/models/prolepsiscommunityreport.php'; 
 
class ElgPedyModelMotherChildCareReportOld extends PedyDataEdit
{	
	...
	function getState() 
	{
		...
		$this->modelClinics = new ElgPedyModelClinicalTransactionReportOld($state);
