...
class ElgPedyModelChildPsychoOld extends PedyDataEdit
{	
	function getState() 
	{
	...
	{
		$this->query->clear();
		$this->query->select('#__ClinicTransaction.ClinicDepartmentId, ClinicTransactionId, #__ClinicTransaction.UserId, #__ClinicTransaction.HealthUnitId, ClinicTypeId, ClinicIncidentId, Quantity, RefDate' )
