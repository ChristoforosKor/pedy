...
class JFormFieldUserUnitExactUni extends JFormFieldList {

    public $type = 'UserUnitExactUni';
	...
	-> innerJoin ("pedy.HealthUnit on HealthUnitRel.HealthUnitId = HealthUnit.HealthUnitId and HealthUnit.COVIDVACCINEUNI = 1")
            ...
            $q2 -> select ("HealthUnitId, DescShortEL," . $admin -> HealthUnitId . ", HealthUnitTypeId")
                    ...
                    -> where ("(HealthDistrictId != " . $admin -> HealthDistrictId . " and HealthUnitTypeId=26 and HealthUnit.COVIDVACCINEUNI = 1) or (HealthDistrictId = " . $admin -> HealthDistrictId . " and HealthUnitTypeId=1 and HealthUnit.COVIDVACCINEUNI = 1 )") 
                    -> order ("DescEL");
            ...
            $query -> select( "HealthUnit.HealthUnitId, HealthUnit.DescEL")
                -> from("Users")
                -> innerJoin("HealthUnit on Users.HealthUnitId = HealthUnit.HealthUnitId and HealthUnit.COVIDVACCINEUNI = 1 ")
