...
class JFormFieldUserUnitExactHome extends JFormFieldList {

    public $type = 'UserUnitExactHome';
	...
	-> innerJoin ("pedy.HealthUnit on HealthUnitRel.HealthUnitId = HealthUnit.HealthUnitId and HealthUnit.COVIDVACCINEHOME = 1")
            ...
            $q2 -> select ("HealthUnitId, DescShortEL," . $admin -> HealthUnitId . ", HealthUnitTypeId")
                    ...
                    -> where ("(HealthDistrictId != " . $admin -> HealthDistrictId . " and HealthUnitTypeId=26 and HealthUnit.COVIDVACCINEHOME = 1) or (HealthDistrictId = " . $admin -> HealthDistrictId . " and HealthUnitTypeId=1 and HealthUnit.COVIDVACCINEHOME = 1 )") 
                    -> order ("DescEL");
            ...
            $query -> select( "HealthUnit.HealthUnitId, HealthUnit.DescEL")
                -> from("Users")
                -> innerJoin("HealthUnit on Users.HealthUnitId = HealthUnit.HealthUnitId and HealthUnit.COVIDVACCINEHOME = 1 ")
